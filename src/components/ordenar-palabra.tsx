...
export function OrdenarPalabra({
  ...
  palabra: string;
  setPalabraIngresada: React.Dispatch<React.SetStateAction<string>>;
  nivel: number;
  ...
  return (
    <Card className="w-full max-w-4xl">
      <CardHeader>
        ...
        <CardDescription>
          Dale click a 2 casilleros para intercambiar su orden hasta encontrar
        ...
        <div className="flex w-full justify-center space-x-2 items-center">
          {letters.map((letter, index) => (
            <Button
              ...
              className={`aspect-square flex-shrink text-lg ${
          ...
          <div
            className={`${palabraIngresada === palabra ? "pl-4" : "hidden"} `}
          >
            <Check color="#30d15b" />
          </div>
        </div>
