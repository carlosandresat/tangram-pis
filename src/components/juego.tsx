  ...
  if (jugando) {
    return (
      ...
      <div className="w-full flex flex-col justify-center items-center pt-8 space-y-6">
        ...
        <a href="https://www.canva.com/design/DAGLW2wMkeM/jIyF0qrzJgOMOUdXSjD4vw/view?utm_content=DAGLW2wMkeM&utm_campaign=designshare&utm_medium=link&utm_source=viewer" target="_blank"><Button variant="outline" className="h-12">Instrucciones y <br className="md:hidden"></br> Autoevaluación</Button></a>
